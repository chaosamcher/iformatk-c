...
port_init:
	...
	// GPIOC (der Port mit Button) einrichten
    

	// GPIOA (der Port mit LED) einrichten
	

button_einlesen:       
    // Code um Buttonstatus einzulesen
    b verzweigung
   
verzweigung:
    // code für verzweigung
    b led_ein

led_ein:
    // Code um LED ein zu schalten
    b button_einlesen 

led_aus:
    // Code um LED auszuschalten
    b button_einlesen